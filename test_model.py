...
class LaneNetTusimpleTrainer(object):
    ...
    def __init__(self, cfg):
        ...
        self.checkpoint = tf.train.Checkpoint(optimizer=self.optimizer, model=self._model)
...
ch = tf.train.Checkpoint(model)
ch.restore('./model/tusimple/vgg_lanenet/lanenet_train_miou=0.3746.ckpt/ckpt-2.data-00000-of-00001')
#model.load_weights('./model/tusimple/vgg_lanenet/lanenet_train_miou=0.3746.ckpt')